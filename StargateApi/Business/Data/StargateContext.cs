...
public class StargateContext(DbContextOptions options) : DbContext(options)
{
    ...
    private static void SeedPeople(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AstronautDetail>().HasData(
            ...
            new AstronautDetail
            {
                Id = 6, PersonId = 17, CurrentRank = "Colonel",
                CurrentDutyTitle = "RETIRED",
            ...
            new AstronautDetail
            {
                Id = 7, PersonId = 18, CurrentRank = "Colonel",
                CurrentDutyTitle = "RETIRED",
            ...
            new AstronautDetail
            {
                Id = 8, PersonId = 19, CurrentRank = "Lieutenant Colonel",
                CurrentDutyTitle = "Flight Engineer",
                CareerStartDate = new DateTime(2013, 6, 17, 0, 0, 0, DateTimeKind.Utc)
            },
            new AstronautDetail
            {
                Id = 9, PersonId = 20, CurrentRank = "Major",
